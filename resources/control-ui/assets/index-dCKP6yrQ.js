...
… truncated (${n.total} chars, showing first ${n.text.length}).`:"";if(n.text.length>Pu){const o=`<pre class="code-block">${Bu(`${n.text}${s}`)}</pre>`,l=bs.sanitize(o,{ALLOWED_TAGS:wa,ALLOWED_ATTR:xa});return t.length<=Xn&&Aa(t,l),l}const i=N.parse(`${n.text}${s}`),a=bs.sanitize(i,{ALLOWED_TAGS:wa,ALLOWED_ATTR:xa});return t.length<=Xn&&Aa(t,a),a}function Bu(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}const Fu=1500,Uu=2e3,ao="复制为 Markdown",Ku="已复制",Hu="复制失败";async function zu(e){if(!e)return!1;try{return await navigator.clipboard.writeText(e),!0}catch{return!1}}function jt(e,t){e.title=t,e.setAttribute("aria-label",t)}function ju(e){const t=e.label??ao;return c`
    <button
      class="chat-copy-btn"
      type="button"
      title=${t}
...
`:""}*No output — tool completed successfully.*`;t(u)}:void 0,o=i&&(e.text?.length??0)<=op,l=i&&!o,p=i&&o,d=!i;return c`
    <div
    ...
    >
      <div class="chat-tool-card__header">
        ...
        ${a?c`<span class="chat-tool-card__action">${i?"查看":""} ${V.check}</span>`:g}
        ${d&&!a?c`<span class="chat-tool-card__status">${V.check}</span>`:g}
      </div>
      ${s?c`<div class="chat-tool-card__detail">${s}</div>`:g}
      ${d?c`<div class="chat-tool-card__status-text muted">已完成</div>`:g}
  ...
  `}function mp(e,t,n,s){const i=new Date(t).toLocaleTimeString([],{hour:"numeric",minute:"2-digit"}),a=s?.name??"助手";return c`
    <div class="chat-group assistant">
      ${li("assistant",s)}
      <div class="chat-group-messages">
  ...
  `}function yp(e,t){const n=Xs(e.role),s=t.assistantName??"助手",i=n==="user"?"你":n==="assistant"?s:n,a=n==="user"?"user":n==="assistant"?"assistant":"other",r=new Date(e.timestamp).toLocaleTimeString([],{hour:"numeric",minute:"2-digit"});return c`
  ...
  `}function li(e,t){const n=Xs(e),s=t?.name?.trim()||"助手",i=t?.avatar?.trim()||"",a=n==="user"?"U":n==="assistant"?s.charAt(0).toUpperCase()||"A":n==="tool"?"⚙":"?",r=n==="user"?"user":n==="assistant"?"assistant":n==="tool"?"tool":"other";return i&&n==="assistant"?bp(i)?c`<img
        class="chat-avatar ${r}"
        src="${i}"
        alt="${s}"
  ...
  `}function Cp(e){const t=e.connected,n=e.sending||e.stream!==null,s=!!(e.canAbort&&e.onAbort),a=e.sessions?.sessions?.find(v=>v.key===e.sessionKey)?.reasoningLevel??"off",r=e.showThinking&&a!=="off",o={name:e.assistantName,avatar:e.assistantAvatar??e.assistantAvatarUrl??null},l=(e.attachments?.length??0)>0,p=e.connected?l?"添加消息或粘贴更多图片...":"输入消息 (↩ 发送, Shift+↩ 换行, 可粘贴图片)":"连接到网关后开始聊天…",d=e.splitRatio??.6,u=!!(e.sidebarOpen&&e.onCloseSidebar),h=c`
    ...
    >
      ${e.loading?c`<div class="muted">正在加载聊天记录…</div>`:g}
...
\`\`\``)}})}
      ...
      ${e.queue.length?c`
            <div class="chat-queue" role="status" aria-live="polite">
              <div class="chat-queue__title">队列中 (${e.queue.length})
  ...
  `}function Ia(e){const{schema:t,value:n,path:s,hints:i,disabled:a,onPatch:r,inputType:o}=e,l=e.showLabel??!0,p=te(s,i),d=p?.label??t.title??$e(String(s.at(-1))),u=p?.help??t.description,h=p?.sensitive??Lp(s),v=p?.placeholder??(h?"••••":t.default!==void 0?`默认: ${t.default}`:""),$=n??"";return c`
    <div class="cfg-field">
  ...
  `}function Bp(e){const{schema:t,value:n,path:s,hints:i,unsupported:a,disabled:r,onPatch:o}=e,l=e.showLabel??!0,p=te(s,i),d=p?.label??t.title??$e(String(s.at(-1))),u=p?.help??t.description,h=Array.isArray(t.items)?t.items[0]:t.items;if(!h)return c`
    ...
    <div class="cfg-array">
      <div class="cfg-array__header">
        ...
        <span class="cfg-array__count">${v.length} 项</span>
        <button
          type="button"
      ...
      <main class="config-main">
        ...
        <div class="config-actions">
          <div class="config-actions__left">
            ${_?c`
              <span class="config-changes-badge">${e.formMode==="raw"?"有未保存的更改":`${w.length} 个未保存的更改`}</span>
            `:c`
  ...
  `}function we(e){const{channelId:t,props:n}=e,s=n.configSaving||n.configSchemaLoading;return c`
    <div style="margin-top: 16px;">
      ${n.configSchemaLoading?c`<div class="muted">加载配置架构中…</div>`:Jp({channelId:t,configValue:n.configForm,schema:n.configSchema,uiHints:n.configUiHints,disabled:s,onPatch:n.onConfigPatch})}
  ...
  `}function tf(e){const{props:t,googleChat:n,accountCountLabel:s}=e;return c`
    <div class="card">
      ...
      <div class="status-list" style="margin-top: 16px;">
        <div>
          <span class="label">已配置</span>
          <span>${n?n.configured?"是":"否":"n/a"}</span>
        </div>
        <div>
          <span class="label">运行中</span>
          <span>${n?n.running?"是":"否":"n/a"}</span>
        </div>
        <div>
...
${e.snapshot?JSON.stringify(e.snapshot,null,2):"暂无快照数据。"}
      </pre>
    </section>
  ...
  `}function xf(e){const t=e.host??"unknown",n=e.ip?`(${e.ip})`:"",s=e.mode??"",i=e.version??"";return`${t} ${n} ${s} ${i}`.trim()}function kf(e){const t=e.ts??null;return t?O(t):"n/a"}function go(e){return e?`${At(e)} (${O(e)})`:"n/a"}function Af(e){if(e.totalTokens==null)return"n/a";const t=e.totalTokens??0,n=e.contextTokens??0;return n?`${t} / ${n}`:String(t)}function Sf(e){if(e==null)return"";try{return JSON.stringify(e,null,2)}catch{return String(e)}}function _f(e){const t=e.state??{},n=t.nextRunAtMs?At(t.nextRunAtMs):"n/a",s=t.lastRunAtMs?At(t.lastRunAtMs):"n/a";return`${t.lastStatus??"n/a"} · next ${n} · last ${s}`}function Tf(e){const t=e.schedule;return t.kind==="at"?`At ${At(t.atMs)}`:t.kind==="every"?`Every ${ir(t.everyMs)}`:`Cron ${t.expr}${t.tz?` (${t.tz})`:""}`}function Ef(e){const t=e.payload;return t.kind==="systemEvent"?`System: ${t.text}`:`Agent: ${t.message}`}function Cf(e){const t=["last",...e.channels.filter(Boolean)],n=e.form.channel?.trim();n&&!t.includes(n)&&t.push(n);const s=new Set;return t.filter(i=>s.has(i)?!1:(s.add(i),!0))}function If(e,t){if(t==="last")return"last";const n=e.channelMeta?.find(s=>s.id===t);return n?.label?n.label:e.channelLabels?.[t]??t}function Mf(e){const t=Cf(e);return c`
        ...
        <div class="stat-grid" style="margin-top: 16px;">
          <div class="stat">
            ...
            <div class="stat-value">
              ${e.status?e.status.enabled?"是":"否":"n/a"}
            </div>
          </div>
          <div class="stat">
    ...
    <section class="card" style="margin-top: 18px;">
      ...
      ${e.jobs.length===0?c`<div class="muted" style="margin-top: 12px;">暂无任务。</div>`:c`
    ...
    <section class="card" style="margin-top: 18px;">
      ...
      ${e.runsJobId==null?c`
          ...
          `:e.runs.length===0?c`<div class="muted" style="margin-top: 12px;">暂无运行记录。</div>`:c`
              <div class="list" style="margin-top: 12px;">
                ${e.runs.map(n=>Pf(n))}
              </div>
            `}
  ...
  `}function Of(e){return c`
    <section class="card">
      ...
      <div class="list" style="margin-top: 16px;">
        ${e.entries.length===0?c`<div class="muted">暂无实例报告。</div>`:e.entries.map(t=>Df(t))}
      </div>
    </section>
  ...
  `}function Kf(e){const t=Vf(e),n=Jf(e);return c`
    ...
    <section class="card">
      ...
      <div class="list" style="margin-top: 16px;">
        ${e.nodes.length===0?c`<div class="muted">未找到节点。</div>`:e.nodes.map(s=>uh(s))}
      </div>
    </section>
    ...
    <section class="card">
      ...
      <div class="list" style="margin-top: 16px;">
        ...
        ${s.length>0?c`
              ...
              ${s.map(i=>jf(i,e))}
            `:g}
        ${n.length===0&&s.length===0?c`<div class="muted">暂无已配对设备。</div>`:g}
      </div>
    </section>
  `}function zf(e,t){const n=e.displayName?.trim()||e.deviceId,s=typeof e.ts=="number"?O(e.ts):"n/a",i=e.role?.trim()?`role: ${e.role}`:"role: -",a=e.isRepair?" · repair":"",r=e.remoteIp?` · ${e.remoteIp}`:"";return c`
    <div class="list-item">
      <div class="list-main">
  ...
  `}function jf(e,t){const n=e.displayName?.trim()||e.deviceId,s=e.remoteIp?` · ${e.remoteIp}`:"",i=`roles: ${is(e.roles)}`,a=`scopes: ${is(e.scopes)}`,r=Array.isArray(e.tokens)?e.tokens:[];return c`
    <div class="list-item">
      <div class="list-main">
        <div class="list-title">${n}</div>
        <div class="list-sub">${e.deviceId}${s}</div>
        <div class="muted" style="margin-top: 6px;">${i} · ${a}</div>
        ${r.length===0?c`<div class="muted" style="margin-top: 6px;">令牌: 无</div>`:c`
            ...
            <div class="list" style="margin-top: 16px;">
              <div class="list-item">
                ...
                <div class="list-meta">
                  ...
                  ${t?g:c`<div class="muted">没有支持 system.run 的节点。</div>`}
                </div>
              </div>

              ${e.agents.length===0?c`<div class="muted">未找到代理。</div>`:e.agents.map(s=>oh(s,e))}
            </div>
  ...
  `}function nh(e){const t=e.targetNodes.length>0,n=e.targetNodeId??"";return c`
    <div class="list" style="margin-top: 12px;">
      ...
      ${e.target==="node"&&!t?c`<div class="muted">暂无节点公告执行审批。</div>`:g}
    </div>
    ...
    <div class="list" style="margin-top: 16px;">
      ...
      <div class="list-item">
        <div class="list-main">
          ...
          <div class="list-sub">
            ${t?"当界面提示不可用时应用。":`默认: ${n.askFallback}。`}
          </div>
        </div>
        <div class="list-meta">
          <label class="field">
      ...
      <div class="list-item">
        <div class="list-main">
          ...
          <div class="list-sub">
            ${t?"允许网关列出的技能可执行文件。":v?`使用默认 (${n.autoAllowSkills?"开启":"关闭"})。`:`覆盖 (${h?"开启":"关闭"})。`}
          </div>
        </div>
        <div class="list-meta">
          <label class="field">
  ...
  `}function ah(e){const t=["agents",e.selectedScope,"allowlist"],n=e.allowlist;return c`
    ...
    <div class="list" style="margin-top: 12px;">
      ${n.length===0?c`<div class="muted">暂无白名单条目。</div>`:n.map((s,i)=>rh(e,s,i))}
    </div>
  `}function rh(e,t,n){const s=t.lastUsedAt?O(t.lastUsedAt):"从未",i=t.lastUsedCommand?as(t.lastUsedCommand,120):null,a=t.lastResolvedPath?as(t.lastResolvedPath,120):null;return c`
    <div class="list-item">
      <div class="list-main">
  ...
  `}function oh(e,t){const n=e.binding??"__default__",s=e.name?.trim()?`${e.name} (${e.id})`:e.id,i=t.nodes.length>0;return c`
    <div class="list-item">
      <div class="list-main">
        ...
        <div class="list-sub">
          ${e.isDefault?"默认代理":"代理"} ·
          ${n==="__default__"?`使用默认 (${t.defaultBinding??"任意"})`:`覆盖: ${e.binding}`}
        </div>
      </div>
      <div class="list-meta">
        <label class="field">
  ...
  `}function ph(e){const t=e.hello?.snapshot,n=t?.uptimeMs?ir(t.uptimeMs):"n/a",s=t?.policy?.tickIntervalMs?`${t.policy.tickIntervalMs}ms`:"n/a",i=(()=>{if(e.connected||!e.lastError)return null;const r=e.lastError.toLowerCase();if(!(r.includes("unauthorized")||r.includes("connect failed")))return null;const l=!!e.settings.token.trim(),p=!!e.password.trim();return!l&&!p?c`
    ...
    <section class="grid grid-cols-3" style="margin-top: 18px;">
      ...
      <div class="card stat-card">
        ...
        <div class="stat-value">
          ${e.cronEnabled==null?"n/a":e.cronEnabled?"已启用":"已禁用"}
        </div>
  ...
  `}const fh=["","off","minimal","low","medium","high"],hh=["","off","on"],gh=[{value:"",label:"inherit"},{value:"off",label:"off (explicit)"},{value:"on",label:"on"}],vh=["","off","on","stream"];function mh(e){if(!e)return"";const t=e.trim().toLowerCase();return t==="z.ai"||t==="z-ai"?"zai":t}function vo(e){return mh(e)==="zai"}function yh(e){return vo(e)?hh:fh}function bh(e,t){return!t||!e||e==="off"?e:"on"}function $h(e,t){return e?t&&e==="on"?"low":e:null}function wh(e){const t=e.result?.sessions??[];return c`
    <section class="card">
      ...
      <div class="table" style="margin-top: 16px;">
        ...
        ${t.length===0?c`<div class="muted">未找到会话。</div>`:t.map(n=>xh(n,e.basePath,e.onPatch,e.onDelete,e.loading))}
      </div>
    </section>
  ...
  `}function Sh(e){const t=e.report?.skills??[],n=e.filter.trim().toLowerCase(),s=n?t.filter(i=>[i.name,i.description,i.source].join(" ").toLowerCase().includes(n)):t;return c`
    <section class="card">
      ...
      ${s.length===0?c`<div class="muted" style="margin-top: 16px;">未找到技能。</div>`:c`
            <div class="list" style="margin-top: 16px;">
              ${s.map(i=>_h(i,e))}
            </div>
          `}
    ...
    <div class="list-item">
      <div class="list-main">
        ...
        <div class="chip-row" style="margin-top: 6px;">
          ...
          ${e.disabled?c`<span class="chip chip-warn">已禁用</span>`:g}
        </div>
        ${r.length>0?c`
              <div class="muted" style="margin-top: 6px;">
                缺失: ${r.join(", ")}
  ...
  `}function Eh(e){const t=Ch(e.sessionKey,e.sessionsResult),n=e.onboarding,s=e.onboarding,i=e.onboarding?!1:e.settings.chatShowThinking,a=e.onboarding?!0:e.settings.chatFocusMode,r=c`<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12a9 9 0 1 1-9-9c2.52 0 4.93 1 6.74 2.74L21 8"></path><path d="M21 3v5h-5"></path></svg>`,o=c`<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 7V4h3"></path><path d="M20 7V4h-3"></path><path d="M4 17v3h3"></path><path d="M20 17v3h-3"></path><circle cx="12" cy="12" r="3"></circle></svg>`;return c`
    <div class="chat-controls">
      ...
      <button
        ...
        aria-pressed=${a}
        title=${s?"引导过程中已禁用":"切换专注模式 (隐藏侧边栏和页面标题)"}
      >
        ${o}
      </button>
    </div>
      ...
      <header class="topbar">
        <div class="topbar-left">
          <button
            ...
            title="${e.settings.navCollapsed?"展开侧边栏":"收起侧边栏"}"
            aria-label="${e.settings.navCollapsed?"展开侧边栏":"收起侧边栏"}"
          >
